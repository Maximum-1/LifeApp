  ...
  render() {
    ...
    {/* Start term of services insert */}
        <div>
          ...
          <p>Application means the software program provided by the Company downloaded by You on any electronic device, named Maximum 1™ Life App</p>

          <p>Application Store means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.</p>
          ...
          <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Maximum 1™, 5230 West 102nd St. Suite #200, MN 55437.</p>
          ...
          <p>Subscriptions refer to the services or access to the Service offered on a subscription basis by the Company to You.</p>

          <p>Free Trial refers to a limited period of time that may be free when purchasing a Subscription.</p>
          ...
          <p>By posting Content to the Service, You do not grant Us the right and license to access and distribute such Content except by express consent or request of law enforcement or government. A subpoena or its local equivalent is required to request non-Content data, and a warrant, court order, or its local equivalent, is required for Content data. Under no additional circumstances will We access and distribute Your Content except to access anonymous ratings data to track usefulness of the app and report findings. No identifying information will be seen or contained in such data exchanges or reports. You retain any and all of Your rights to any Content You submit, post or display on or through the Service and You are responsible for protecting those rights.  </p>
          ...
          <p>We understand Content of the Service’s users is/can be very personal in nature. It may contain Content that may seem unlawful, upsetting, offensive, disgusting, threatening, or otherwise objectionable to others. This is acceptable in order to fulfill the requirements of Service. However, You may not transmit any Content that is unlawful, offensive, upsetting, intended to disgust, threatening, libelous, defamatory, obscene or otherwise objectionable to purposefully injure or retaliate against a third-party including, but not limited to, individuals and groups, governing bodies, organizations, and corporations. Examples of such objectionable Content include, but are not limited to, the following:</p>

          <ul>
            <li><p>Unlawful or promoting unlawful activity.</p>

            </li>
            <li><p>Defamatory, discriminatory, or mean-spirited content, including references or commentary about religion, race, sexual orientation, gender, national/ethnic origin, or other targeted groups.</p>

            </li>
            <li><p>Spam, machine – or randomly – generated, constituting unauthorized or unsolicited advertising, chain letters, any other form of unauthorized solicitation, or any form of lottery or gambling.</p>
            ...
            <li><p>Infringing on any proprietary rights of any party, including patent, trademark, trade secret, copyright, right of publicity or other rights.</p>

            </li>
            <li><p>Impersonating any person or entity including the Company and its employees or representatives.</p>

            </li>
            <li><p>Violating the privacy of any third person.</p>

            </li>
            <li><p>False information and features.</p>

            </li>
          </ul>

          <p>The Company can also limit or revoke the use of the Service if You post or transmit such objectionable Content. You understand that by using the Service, You may choose to share Content for rehabilitation purposes (e.g. sharing with a mental health practitioner) or personal reasons (e.g. to receive guidance or support). You agree that under no circumstances will the Company be liable in any way for any Content, including any errors or omissions in any content, or any loss or damage of any kind incurred as a result of your use of any Content. </p>
          ...
          <p>The Company is as of 5/23/2020 limited in what individualized support it will offer until it’s able to expand its resources. However, Company will keep a record of user support requests made via email to: marius.massie@iammaximum1.com. These requests will be addressed as soon as possible. But You acknowledge that the Company has no liability related to the integrity of Content or the failure to successfully restore Content to a usable state.</p>
          ...
          <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at marius.massie@iammaximum1.com and include in Your notice a detailed description of the alleged infringement.</p>
          ...
          <ul>
            <li><p>An electronic or physical signature of the person authorized to act on behalf of the owner of the copyright's interest.</p>

            </li>
            <li><p>A description of the copyrighted work that You claim has been infringed, including the URL (i.e., web page address) of the location where the copyrighted work exists or a copy of the copyrighted work.</p>

            </li>
            <li><p>Identification of the URL or other specific location on the Service where the material that You claim is infringing is located.</p>

            </li>
            <li><p>Your address, telephone number, and email address.</p>

            </li>
            <li><p>A statement by You that You have a good faith belief that the disputed use is not authorized by the copyright owner, its agent, or the law.</p>

            </li>
            <li><p>A statement by You, made under penalty of perjury, that the above information in Your notice is accurate and that You are the copyright owner or authorized to act on the copyright owner's behalf.</p>

            </li>
          </ul>

          <p>You can contact our copyright agent via email at marius.massie@iammaximum1.com. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
          ...
          <ul>
            <li><p>By email: marius.massie@iammaximum1.com</p>
